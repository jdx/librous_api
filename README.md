...
get the app created:
    ...
    $ heroku apps:create librous
    Creating librous... done, stack is cedar
    http://librous.herokuapp.com/ | git@heroku.com:librous.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://librous.herokuapp.com deployed to Heroku

    To git@heroku.com:librous.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://librous.herokuap.com
    ["Hello" :from Heroku]
